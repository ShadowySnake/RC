          ...
          if(strcmp(received,"Account banned!") == 0) banned = 1;
                ...
                else if(((strcmp(received,"login")==0) || (strcmp(received,"register")==0)) && (logged == 1))
                {
                  ...
                  fflush(stdout);
                      ...
                      printf("Commands for all users: 'all_commands' 'show_champs' 'delete_account'\n");
                      printf("Commands for normal users only: 'join_champ' 'postpone'\n");
                      printf("Commands for administrators only: 'history' 'create_champ' 'ban_account' 'unban_account' 'delete_champ'\n");
                      fflush(stdout);
                      }
                      ...
                      {
                        printf("Your account will be deleted!\n");fflush(stdout);
                      ...
                      else if( (strcmp(received,"delete_champ") == 0) && (logged == 1))
                      {
                        write(sd,"try_delete",sizeof("try_delete"));
                        read(sd,&received,sizeof(received));
                        if(strcmp(received,"Must be an admin!") == 0) printf("%s\n",received);
                          ...
                          char nume_champ[100];
                          printf("Dati numele campionatului care sa fie sters: ");fflush(stdin);
                          scanf("%s",nume_champ);fflush(stdin);
                          write(sd,nume_champ,sizeof(nume_champ));
                          read(sd,&received,sizeof(received));
                          printf("%s\n",received); }
